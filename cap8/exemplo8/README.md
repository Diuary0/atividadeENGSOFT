...
Estude o código da função `valor_abs`, implementada no arquivo [sistema.py](./sistema.py). Ela calcula o valor absoluto de um número.

Estude o teste desta função, implementado em [teste.py](./teste.py)
